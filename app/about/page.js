    ...
    <PageWrapper className={styles.about}>
      ...
      <section className={styles.about__column} grid-col="2">
        <p className={styles.about__headline}>
          Hey! I'm Cristhian, a New York based Freelance Developer & Designer. My interests lays in
          the intersection of design and the web. I love to think about the value of design in the
          work I do.
          <br />
        </p>
        <p className={styles.about__headline}>
          {/* ADD LINKS TO PLAYLISTS,BOOKS AND PHOTOS INSIDE WORDS */}
          On my time off you can find me reading books, thinking about a new personal project,
          enjoying music, learning some new language on duolingo or capturing moments through
          photography.
        </p>
